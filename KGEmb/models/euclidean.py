...
class BaseE(KGModel):
    ...
    def __init__(self, args, disease_ids=None, restrict_to_diseases=False):
        ...
        if self.restrict_to_diseases and self.disease_ids is not None:
            ...
            print("Number of disease nodes (Euclidean):", mask.sum().item())
    ...
    def similarity_score(self, lhs_e, rhs_e, eval_mode):
        """Compute similarity scores of queries against targets."""
        if self.sim == "dot":
            if eval_mode:
...
class TransE(BaseE):
    ...
    def __init__(self, args, disease_ids=None, restrict_to_diseases=False):
        super(TransE, self).__init__(args, disease_ids, restrict_to_diseases)
        self.sim = "dist"
...
class CP(BaseE):
    ...
    def __init__(self, args, disease_ids=None, restrict_to_diseases=False):
        super(CP, self).__init__(args, disease_ids, restrict_to_diseases)
        self.sim = "dot"
...
class MurE(BaseE):
    ...
    def __init__(self, args, disease_ids=None, restrict_to_diseases=False):
        super(MurE, self).__init__(args, disease_ids, restrict_to_diseases)
...
class RotE(BaseE):
    ...
    def __init__(self, args, disease_ids=None, restrict_to_diseases=False):
        super(RotE, self).__init__(args, disease_ids, restrict_to_diseases)
        self.rel_diag = nn.Embedding(self.sizes[1], self.rank)
        self.rel_diag.weight.data = 2 * torch.rand((self.sizes[1], self.rank), dtype=self.data_type) - 1.0
        self.sim = "dist"
...
class RefE(BaseE):
    ...
    def __init__(self, args, disease_ids=None, restrict_to_diseases=False):
        super(RefE, self).__init__(args, disease_ids, restrict_to_diseases)
        self.rel_diag = nn.Embedding(self.sizes[1], self.rank)
        self.rel_diag.weight.data = 2 * torch.rand((self.sizes[1], self.rank), dtype=self.data_type) - 1.0
        self.sim = "dist"
...
class AttE(BaseE):
    ...
    def __init__(self, args, disease_ids=None, restrict_to_diseases=False):
        super(AttE, self).__init__(args, disease_ids, restrict_to_diseases)
        self.sim = "dist"
